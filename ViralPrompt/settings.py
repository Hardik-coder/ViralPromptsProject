"""
Django settings for ViralPrompt project.
...
SECRET_KEY = 'django-insecure-%7y3)9i+f_@bu7kq&*!f7-1uw2$&0oz-trtti54^)hhmr4g9$2'
...
WSGI_APPLICATION = 'ViralPrompt.wsgi.application'
